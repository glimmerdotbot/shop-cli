export const resourceToType: Record<string, string> = {
  ...
  'checkout-profiles': 'CheckoutProfile',
  ...
  'delivery-profile-locations': 'Location',
  ...
  refunds: 'Refund',
  returns: 'Return',
  'returnable-fulfillments': 'ReturnableFulfillment',
  'reverse-deliveries': 'ReverseDelivery',
  'reverse-fulfillment-orders': 'ReverseFulfillmentOrder',
